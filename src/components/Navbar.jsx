  ...
  return (
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        <img src={logo2} alt='logo' className='h-15 object-contain' style={{width:"8rem"}}/>
        <p className='text-white text-[18px] font-bold cursor-pointer flex'>Praddos Kanna&nbsp;
        {/* <span className='sm:block hidden'>| Blockchain Dev</span> */}
        </p>
        </Link>
